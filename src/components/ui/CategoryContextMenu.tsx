...
const CategoryContextMenu = ({ children }: DropdownMenuProps) => {
    return (
...
const CategoryContextMenuItem = (props: DropdownMenuItemProps) => {
...
export { CategoryContextMenu, CategoryContextMenuItem };